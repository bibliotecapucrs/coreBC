...
namespace LibCore1\Hooks;

if (!class_exists('\\LibCore1\\Hooks\\LC1Hooks')) {
    /**
     * This class will be hook into WordPress and make changes to the theme.<br>
     * If you want to hook to enable or add feature to the theme, please use \LibCore1\LibCore1() class.
     */
    class LC1Hooks
    {
         ...
         * 
         * $LC1Hooks = new \LibCore1\Hooks\LC1Hooks();
         ...
         * 
         * @access private Do not access this method directly. This is for hook callback not for direct call.
         * @global string $libcore_title_separator
         * @return string Return the new title separator.
         */
        public function modifyTitleSeparator()
        {
            global $libcore_title_separator;

            return $libcore_title_separator;
