...
class Calendario extends wp_widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => 'core_calendario',
			'description' => 'Calendário de eventos.',
		);
		parent::__construct( 'core_calendario', 'Core Calendário', $widget_ops );
	}
